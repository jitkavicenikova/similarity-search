...
public class SoilTransformerIntegrationTest {
    ...
    void testFullTransform() throws Exception {
        performTransformationTest("/transformer/full", "test-data/soil-data.csv", "test-data/soil-data-full.json");
    }

    @Test
    @WithMockUser(username = "user")
    void testIncrementTransform() throws Exception {
        performTransformationTest("/transformer/increment", "test-data/soil-data.csv", "test-data/soil-data-increment.json");
    }
